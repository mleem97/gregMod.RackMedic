# AGENTS.md — Hinweise für KI-Agenten (gregMod.RackMedic)

Repo: [https://github.com/mleem97/gregMod.RackMedic](https://github.com/mleem97/gregMod.RackMedic) · Lizenz: Apache-2.0 · Version: siehe `VERSION`.
